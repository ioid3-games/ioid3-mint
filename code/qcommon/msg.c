...
void MSG_WriteDeltaUsercmdKey(msg_t *msg, int key, usercmd_t *from, usercmd_t *to) {
	...
	if (from->angles[0] == to->angles[0] && from->angles[1] == to->angles[1] && from->angles[2] == to->angles[2] && from->forwardmove == to->forwardmove && from->rightmove == to->rightmove && from->upmove == to->upmove && from->buttons == to->buttons && from->stateValue == to->stateValue) {
...
Validate net fields and setup each field's numElementArrays. Returns pointer to error message or NULL if no error.
=======================================================================================================================================
*/
...
=======================================================================================================================================
*/
static void MSG_WriteDeltaNetFields(msg_t *msg, void *from, void *to, netFields_t *stateFields, int numSendFields) {
	int i, n;
	netField_t *field;
	int trunc;
	float fullFloat;
...
=======================================================================================================================================
*/
static void MSG_ReadDeltaNetFields(msg_t *msg, void *from, void *to, netFields_t *stateFields, int numReadFields, int startBit, int print) {
	int i, n;
	netField_t *field;
	int trunc;
	int *fromF, *toF;
...
=======================================================================================================================================
*/
void MSG_WriteDeltaEntity(msg_t *msg, sharedEntityState_t *from, sharedEntityState_t *to, qboolean force) {
	int lc;
