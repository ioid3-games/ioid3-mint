	...
	while ((i_now = i_now->next)) {
		...
		switch (i_now->op) {
			...
			case OP_NE:
				...
				emitJump(
					i_now->arg.i, (i_now->op == OP_EQ ? branchTrue : branchFalse),
					4*cr7+eq, 0
				);
			...
			case OP_GEI:
				...
				emitJump(
					i_now->arg.i, (i_now->op == OP_LTI ? branchTrue : branchFalse),
					4*cr7+lt, 0
				);
			...
			case OP_LEI:
				...
				emitJump(
					i_now->arg.i, (i_now->op == OP_GTI ? branchTrue : branchFalse),
					4*cr7+gt, 0
				);
			...
			case OP_GEU:
				...
				emitJump(
					i_now->arg.i, (i_now->op == OP_LTU ? branchTrue : branchFalse),
					4*cr7+lt, 0
				);
			...
			case OP_LEU:
				...
				emitJump(
					i_now->arg.i, (i_now->op == OP_GTU ? branchTrue : branchFalse),
					4*cr7+gt, 0
				);
			...
			case OP_NEF:
				...
				emitJump(
					i_now->arg.i, (i_now->op == OP_EQF ? branchTrue : branchFalse),
					4*cr7+eq, 0
				);
			...
			case OP_GEF:
				...
				emitJump(
					i_now->arg.i, (i_now->op == OP_LTF ? branchTrue : branchFalse),
					4*cr7+lt, 0
				);
			...
			case OP_LEF:
				...
				emitJump(
					i_now->arg.i, (i_now->op == OP_GTF ? branchTrue : branchFalse),
					4*cr7+gt, 0
				);
