...
/**************************************************************************************************************************************
 Included first by ALL program modules. A user mod should never modify this file.
**************************************************************************************************************************************/
...
Fast vector normalize routine that does not check to make sure that length != 0, nor does it return length, uses rsqrt approximation.
=======================================================================================================================================
*/
...
// New fields cannot be added to sharedPlayerState_t without updating playerState_t in bg_public.h(and thus breaking mod compatiblity).
...
// Also see CL_MAX_SPLITVIEW in client.h for lowering max supported splitview clients in client/renderer, while still keep network and mod compatibility.
