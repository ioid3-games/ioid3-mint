...
// 		printf("starting %d threads\n", numthreads);
		...
		for (i = 0; i < numthreads; i++) {
			threadhandle[i] = CreateThread(
			   NULL, // LPSECURITY_ATTRIBUTES lpsa, 0, // DWORD cbStack, (LPTHREAD_START_ROUTINE)func, // LPTHREAD_START_ROUTINE lpStartAddr, (LPVOID)(intptr_t)i, // LPVOID lpvThreadParm, 0, //   DWORD fdwCreate, &threadid[i]);
...
void AddThread(void (*func)(int)) {
	...
	if (numthreads == 1) {
		...
		thread->handle = CreateThread(
				   NULL, // LPSECURITY_ATTRIBUTES lpsa, 0, // DWORD cbStack, (LPTHREAD_START_ROUTINE)func, // LPTHREAD_START_ROUTINE lpStartAddr, (LPVOID)(intptr_t)thread->threadid, // LPVOID lpvThreadParm, 0, // DWORD fdwCreate, &thread->id);
