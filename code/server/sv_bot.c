...
=======================================================================================================================================
*/
client_t *SV_ClientForPlayerNum(int clientNum) {

	if (clientNum < 0 || clientNum >= sv_maxclients->integer) {
		return NULL;
	}

	return svs.players[clientNum].client;
}
...
Sends a client command for the specified clientNum.
=======================================================================================================================================
*/
void SV_ForceClientCommand(int clientNum, const char *command) {
	client_t *client = SV_ClientForPlayerNum(clientNum);
...
int SV_BotGetServerCommand(int clientNum, char *buf, int size) {
	...
	cl = SV_ClientForPlayerNum(clientNum);
...
=======================================================================================================================================
*/
int EntityInPVS(int clientNum, int entityNum) {
	client_t *cl;
