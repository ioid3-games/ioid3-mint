...
bot_character_t *BotLoadCharacterFromFile(char *charfile, int skill) {
	...
	ch = (bot_character_t *)trap_HeapMalloc(sizeof(bot_character_t) + MAX_CHARACTERISTICS * sizeof(bot_characteristic_t));
...
int BotInterpolateCharacters(int handle1, int handle2, float desiredskill) {
	...
	out = (bot_character_t *)trap_HeapMalloc(sizeof(bot_character_t) + MAX_CHARACTERISTICS * sizeof(bot_characteristic_t));
