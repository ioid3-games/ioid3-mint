...
/*
	if (debug) {
		...
		Com_sprintf(str, sizeof(str), "print \"head: %d, %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n\"", ent->client->topMarker, ent->client->playerMarkers[0].time, ent->client->playerMarkers[1].time, ent->client->playerMarkers[2].time, ent->client->playerMarkers[3].time, ent->client->playerMarkers[4].time, ent->client->playerMarkers[5].time, ent->client->playerMarkers[6].time, ent->client->playerMarkers[7].time, ent->client->playerMarkers[8].time, ent->client->playerMarkers[9].time, ent->client->playerMarkers[10].time, ent->client->playerMarkers[11].time, ent->client->playerMarkers[12].time, ent->client->playerMarkers[13].time, ent->client->playerMarkers[14].time, ent->client->playerMarkers[15].time, ent->client->playerMarkers[16].time);
	...
	if (j != k) {
		...
		if (j != ent->player->topMarker) {
			...
			if (debug && debugger != NULL) {
				...
				Com_sprintf(msg, sizeof(msg), "print \"^1Rec: time: %d, j: %d, k: %d, origin: %0.2f %0.2f %0.2f\n"
					"^2frac: %0.4f, origin1: %0.2f %0.2f %0.2f, origin2: %0.2f %0.2f %0.2f\n"
					"^7level.time: %d, est time: %d, level.time delta: %d, est real ping: %d\n\"", time, ent->player->playerMarkers[j].time, ent->player->playerMarkers[k].time, ent->r.currentOrigin[0], ent->r.currentOrigin[1], ent->r.currentOrigin[2], frac, ent->player->playerMarkers[j].origin[0], ent->player->playerMarkers[j].origin[1], ent->player->playerMarkers[j].origin[2], ent->player->playerMarkers[k].origin[0], ent->player->playerMarkers[k].origin[1], ent->player->playerMarkers[k].origin[2], level.time, level.time + debugger->player->frameOffset, level.time - time, level.time + debugger->player->frameOffset - time);
		...
		if (debug && debugger != NULL) {
			Com_sprintf(msg, sizeof(msg), "print \"^1No rec: time: %d, j: %d, k: %d, origin: %0.2f %0.2f %0.2f\n"
				"^2frac: %0.4f, origin1: %0.2f %0.2f %0.2f, origin2: %0.2f %0.2f %0.2f\n"
				"^7level.time: %d, est time: %d, level.time delta: %d, est real ping: %d\n\"", time, level.time, level.time, ent->r.currentOrigin[0], ent->r.currentOrigin[1], ent->r.currentOrigin[2], 0.0f, ent->r.currentOrigin[0], ent->r.currentOrigin[1], ent->r.currentOrigin[2], ent->r.currentOrigin[0], ent->r.currentOrigin[1], ent->r.currentOrigin[2], level.time, level.time + debugger->player->frameOffset, level.time - time, level.time + debugger->player->frameOffset - time);
