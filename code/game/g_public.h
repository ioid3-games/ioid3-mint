...
typedef enum {
	...
	G_FS_SEEK, G_FS_TELL, // (fileHandle_t f);
	G_FS_FCLOSE_FILE, // (fileHandle_t f);
	G_FS_GETFILELIST, G_FS_DELETE, // (const void *path);
	G_FS_RENAME, // (const void *from, const void *to);

	G_PC_ADD_GLOBAL_DEFINE, G_PC_REMOVE_ALL_GLOBAL_DEFINES, G_PC_LOAD_SOURCE, G_PC_FREE_SOURCE, G_PC_READ_TOKEN, G_PC_UNREAD_TOKEN, G_PC_SOURCE_FILE_AND_LINE,
	...
	BOTLIB_LIBVAR_SET, BOTLIB_LIBVAR_GET, BOTLIB_START_FRAME, BOTLIB_LOAD_MAP, BOTLIB_UPDATENTITY, BOTLIB_TEST,
	...
	BOTLIB_AAS_BBOX_AREAS = 301, BOTLIB_AAS_AREA_INFO, BOTLIB_AAS_LOADED, BOTLIB_AAS_INITIALIZED, BOTLIB_AAS_PRESENCE_TYPE_BOUNDING_BOX, BOTLIB_AAS_TIME,

	BOTLIB_AAS_POINT_AREA_NUM, BOTLIB_AAS_TRACE_PLAYER_BBOX, BOTLIB_AAS_TRACE_AREAS,

	BOTLIB_AAS_POINT_CONTENTS, BOTLIB_AAS_NEXT_BSP_ENTITY, BOTLIB_AAS_VALUE_FOR_BSP_EPAIR_KEY, BOTLIB_AAS_VECTOR_FOR_BSP_EPAIR_KEY, BOTLIB_AAS_FLOAT_FOR_BSP_EPAIR_KEY, BOTLIB_AAS_INT_FOR_BSP_EPAIR_KEY,
	// aas_move
	BOTLIB_AAS_PREDICT_PLAYER_MOVEMENT = 325, BOTLIB_AAS_ON_GROUND, BOTLIB_AAS_SWIMMING, BOTLIB_AAS_JUMP_REACH_RUN_START, BOTLIB_AAS_AGAINST_LADDER, BOTLIB_AAS_HORIZONTAL_VELOCITY_FOR_JUMP, BOTLIB_AAS_DROP_TO_FLOOR,
	// aas_reach
	BOTLIB_AAS_AREA_REACHABILITY = 350, BOTLIB_AAS_BEST_REACHABLE_AREA, BOTLIB_AAS_BEST_REACHABLE_FROM_JUMP_PAD_AREA, BOTLIB_AAS_NEXT_MODEL_REACHABILITY, BOTLIB_AAS_AREA_GROUND_FACE_AREA, BOTLIB_AAS_AREA_CROUCH, BOTLIB_AAS_AREA_SWIM, BOTLIB_AAS_AREA_LIQUID, BOTLIB_AAS_AREA_LAVA, BOTLIB_AAS_AREA_SLIME, BOTLIB_AAS_AREA_GROUNDED, BOTLIB_AAS_AREA_LADDER, BOTLIB_AAS_AREA_JUMP_PAD, BOTLIB_AAS_AREA_DO_NOT_ENTER,
	// aas_route
	BOTLIB_AAS_TRAVEL_FLAG_FOR_TYPE = 400, BOTLIB_AAS_AREA_CONTENTS_TRAVEL_FLAGS, BOTLIB_AAS_NEXT_AREA_REACHABILITY, BOTLIB_AAS_REACHABILITY_FROM_NUM, BOTLIB_AAS_RANDOM_GOAL_AREA, BOTLIB_AAS_ENABLE_ROUTING_AREA, BOTLIB_AAS_AREA_TRAVEL_TIME, BOTLIB_AAS_AREA_TRAVEL_TIME_TO_GOAL_AREA, BOTLIB_AAS_PREDICT_ROUTE,
	// aas_altroute
...
typedef enum {
	...
	// return restart time(levelTime + delay), -1 to do a full map reload, //    or INT_MAX to prevent map restart.
