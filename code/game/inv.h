...
#define MODELINDEX_BEAMGUN_AMMO	22
#define MODELINDEX_ROCKETS			23
#define MODELINDEX_SLUGS			24
#define MODELINDEX_BFG_AMMO			25
...
#define WEAPONINDEX_GRENADELAUNCHER	4
#define WEAPONINDEX_ROCKETLAUNCHER		5
#define WEAPONINDEX_BEAMGUN			6
