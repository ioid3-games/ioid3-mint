...
extern  cvar_t  *r_drawSunRaysOcclusionQuery;
...
float       R_ProcessLightmap( byte **pic, int in_padding, int width, int height, byte **pic_out, qboolean hdrLightmap, int internalFormat );
