...
#define TRAVEL_JUMP				 4 // jumping
#define TRAVEL_BARRIERJUMP		 5 // jumping onto a barrier
#define TRAVEL_WALKOFFLEDGE		 6 // walking of a ledge
#define TRAVEL_SWIM				 7 // swimming
#define TRAVEL_WATERJUMP		 8 // jump out of the water
#define TRAVEL_ROCKETJUMP		 9 // rocket jumping required for travel
#define TRAVEL_BFGJUMP			10 // bfg jumping required for travel
#define TRAVEL_TELEPORT			11 // teleportation
#define TRAVEL_JUMPPAD			12 // jump pad
#define TRAVEL_FUNCBOB			13 // func bob
#define TRAVEL_ELEVATOR			14 // travel by elevator
#define TRAVEL_LADDER			15 // climbing a ladder
#define TRAVEL_GRAPPLEHOOK		16 // grappling hook required for travel
#define TRAVEL_DOUBLEJUMP		17 // double jump
#define TRAVEL_RAMPJUMP			18 // ramp jump
#define TRAVEL_STRAFEJUMP		19 // strafe jump
