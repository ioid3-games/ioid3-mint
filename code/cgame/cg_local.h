...
/**************************************************************************************************************************************
	...
	The menu code needs to get both key and char events, but to avoid duplicating the paths, the char events are just distinguished by
	or'ing in K_CHAR_FLAG (ugly).
...
typedef struct {
	...
	int breathPuffTime;
	// when playerinfo is changed, the loading of models/skins/sounds can be deferred until you are dead, to prevent hitches in gameplay
