...
Add message to team chat box if enabled otherwise add message to notify messages (for tell messages).
Add message to notify messages if local player is on a different team.
=======================================================================================================================================
*/
