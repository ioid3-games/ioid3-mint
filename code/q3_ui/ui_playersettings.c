...
static void PlayerSettings_SaveChanges(void) {
	...
	// handicap
	trap_Cvar_SetValue(Com_LocalPlayerCvarName(s_playersettings.localPlayerNum, "handicap"), 100 - s_playersettings.handicap.curvalue * 5);
	// effects color
	trap_Cvar_SetValue(Com_LocalPlayerCvarName(s_playersettings.localPlayerNum, "color1"), uitogamecode[s_playersettings.effects.curvalue]);
	trap_Cvar_SetValue(Com_LocalPlayerCvarName(s_playersettings.localPlayerNum, "color2"), uitogamecode[s_playersettings.effects2.curvalue]);
}
