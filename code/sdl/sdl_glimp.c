...
void(APIENTRYP qglCompressedTexImage2DARB)(GLenum target, GLint level, GLenum internalformat, Lsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data);
